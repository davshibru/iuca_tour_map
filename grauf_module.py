...
graph_with_weights = {
    ...
    'f8': [(250, 'f7')],
    'f9': [(1350, 'f7'), (250, 'f10'), (100, 'f11')],        # from here
    'f10': [(250, 'f9')],
    ...
    'f17': [(250, 'f13')],
    'f18': [(550, 'f13'), (900, 'f19')],
    'f19': [(900, 'f18'), (626, 'f20'), (900, 'f21'), (670, 'f23')],                    # не было f18
    'f20': [(626, 'f19')],
    ...
    's50': [(715, 's1'), (2000, 't1')],
    's51': [(559, 's26'), (2000, 't28')],                                   # 59 минута
    ...
    't44': [(300, 't43')],
    't45': [(250, 't43'), (316, 't46')],
    't46': [(316, 't45')]                                   # 1:17 капец как будто пару просидел осталость еще алгоритм сделать
}
...
# час 40 все отлично работает тепеь чтобы добраться из одной части в подвала в другую не обязательно идти через 2 этаж
